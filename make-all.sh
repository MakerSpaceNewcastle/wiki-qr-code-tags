...
make-tag "equipment/makita_chop_saw"
make-tag "equipment/workbee_cnc_router"
make-tag "equipment/metal_lathe"
make-tag "equipment/large_bench_grinder"
make-tag "equipment/large_air_compressor"
make-tag "infrastructure/basement_workshop_air_filtration"
make-tag "infrastructure/bosch_tassimo_machine"
make-tag "infrastructure/delonghi_coffee_machine"
make-tag "infrastructure/music_server"
